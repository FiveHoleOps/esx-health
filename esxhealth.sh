        ...
        Select-Object Name, @{
            ...
            Expression = {
                if ($_.PowerState -eq 'PoweredOn') {
                    "$([char]27)[32m$($_.PowerState)$([char]27)[0m"
                } elseif ($_.PowerState -eq 'PoweredOff') {
                    "$([char]27)[31m$($_.PowerState)$([char]27)[0m"
                } else {
                    $_.PowerState
                }
            }
